	...
	<div class="form-group row">
		...
		<div class="form-group row">
			...
			<div class="form-group col-md-10">
				<form class="" name="welcome" action="admin1ed" method="post">
					<input type="hidden" name="stIdcard" id="stIdcard"> <input
						id="myInput" style="width: 30%" align="right" type="text"
					...
					<table class="table table-bordered">
						...
						<tbody id="myTable">
							...
							<tr>
								...
								<td><%=a = a + 1%></td>
								<td><%=list.get(i).getDatedateday() + " / " + list.get(i).getSimpleyear() + " / "
						+ list.get(i).getDatedateyear()%></td>
