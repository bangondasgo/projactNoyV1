...
<input id="myInput" style="width: 30%" align="right" type="text"
    ...
    <table class="table table-bordered">
            ...
            <tr>
              ...
              <th align="center">ยืนยันการเบิก</th>
...
<%
            ...
            <tr >
              ...
              <td align="center"><a  onclick="gotoUpdate('<%=list.get(i).getId()%>')"><button type="button" class="btn btn-default btn-sm">
...
function gotoUpdate(filter) {
	...
	var n = confirm("ยินยัน !");
	if (n == true) {
		document.getElementById("stIdcard").value = filter;
		document.welcome.action="delser";
